...
void test_mph_lookup() {
	...
	assert(mph_lookup(VALUES, 0x0061, hash) != 0);

	hash = mph_hash(G, sizeof(G) / sizeof(*G), 0x0062);
	assert(mph_lookup(VALUES, 0x0062, hash) != 0);

	hash = mph_hash(G, sizeof(G) / sizeof(*G), 0x0063);
	assert(mph_lookup(VALUES, 0x0063, hash) != 0);

	hash = mph_hash(G, sizeof(G) / sizeof(*G), 0x0064);
	assert(mph_lookup(VALUES, 0x0064, hash) != 0);

	hash = mph_hash(G, sizeof(G) / sizeof(*G), 0x0065);
	assert(mph_lookup(VALUES, 0x0065, hash) != 0);
}
