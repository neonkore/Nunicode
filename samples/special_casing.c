...
int main() {
	 ...
	 * at the string boundary or followed by U+0000 */

	_nu_tolower(input1, NU_UNLIMITED, nu_utf8_read, &i1_sigma, 0);
	_nu_tolower(input2, NU_UNLIMITED, nu_utf8_read, &i2_sigma, 0);
	_nu_tolower(input2, input2 + 2, nu_utf8_read, &i3_sigma, 0);
