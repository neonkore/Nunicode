...
SELECT 'Ё' < 'Я' == 1
SELECT 'ё' < 'я' COLLATE NU1300 == 1
SELECT 'Ё' < 'Я' COLLATE NU1300 == 1
SELECT 'ß' == 'ss' == 0
SELECT 'æ' == 'Æ' == 0
SELECT 'æ' == 'Æ' COLLATE NU1300 == 0
SELECT 'æ' == 'Æ' COLLATE NU1300_NOCASE == 1
SELECT 'ß' == 'SS' COLLATE NU1300 == 0
SELECT 'ß' == 'SS' COLLATE NU1300_NOCASE == 1
SELECT 'ß' == 'ss' COLLATE NU1300_NOCASE == 1
SELECT 'ß' == 'ss' COLLATE NU1300 == 0
...
SELECT 'РОССИЯ РУБЛЬ' LIKE '%' || 'ру' || '%' COLLATE NU1300_NOCASE == 1 /* additional LIKE checks */
