 ...
 * - upper(X)
 * - lower(X)
 * - COLLATE NU900 - Unicode 9.0.0 case-sensitive collation
 * - COLLATE NU900_NOCASE - Unicode 9.0.0 case-insensitive collation
 *
 * Suported encodings:
 *
 * - UTF8
...
#if NU_UNICODE_VERSION != 900
#	error "NU900 collations are intended for Unicode 9.0.0 only"
#endif

	REGISTER_COLLATION(rc, db, SQLITE_UTF8, "NU900", nunicode_sqlite3_collate_utf8);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16LE, "NU900", nunicode_sqlite3_collate_utf16le);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16BE, "NU900", nunicode_sqlite3_collate_utf16be);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16, "NU900", nunicode_sqlite3_collate_utf16he);

	REGISTER_COLLATION(rc, db, SQLITE_UTF8, "NU900_NOCASE", nunicode_sqlite3_collate_nocase_utf8);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16LE, "NU900_NOCASE", nunicode_sqlite3_collate_nocase_utf16le);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16BE, "NU900_NOCASE", nunicode_sqlite3_collate_nocase_utf16be);
	REGISTER_COLLATION(rc, db, SQLITE_UTF16, "NU900_NOCASE", nunicode_sqlite3_collate_nocase_utf16he);
